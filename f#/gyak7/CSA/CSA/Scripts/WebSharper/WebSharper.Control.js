(function()
{
  ...
  return{
   Subscribe:function(o1)
   {
    ...
    return e.Subscribe(Observer.New(function(v)
    {
     var m;
     m=last[0];
     (m!=null?m.$==1:false)?o1.OnNext([m.$0,v]):null;
     last[0]={
      $:1,
      $0:v
     };
 ...
 EventModule.Choose=function(c,e)
 {
  ...
  Util.addListener(e,function(x)
  {
   var m;
   m=c(x);
   m==null?null:r.event.Trigger(m.$0);
  });
  return r.event;
 };
 MailboxProcessor=Control.MailboxProcessor=Runtime.Class({
  ...
  resume:function()
  {
   var m;
   m=this.savedCont;
   (m!=null?m.$==1:false)?(this.savedCont=null,this.startAsync(m.$0)):null;
  },
  ...
  TryScan:function(scanner,timeout)
  {
   ...
   return Concurrency.Delay(function()
   {
    ...
    while(!Unchecked.Equals(m$1,null))
     {
      m$2=scanner(m$1.v);
      m$2==null?void(m$1=m$1.n):($this.mailbox.Remove$1(m$1),m$1=null,void(found=m$2));
     }
    m=found;
 ...
 MailboxProcessor.New=Runtime.Ctor(function(initial,token)
 {
  ...
  this.savedCont=null;
  m=this.token;
  m==null?null:(v=(callback=function()
  {
   return $this.resume();

  ...
  while(loop)
   if(t$1==null)
   ...
   else
    {
     ...
     m===0?void(loop=false):m===1?(spine.unshift([true,t$1.Node,t$1.Left]),void(t$1=t$1.Right)):(spine.unshift([false,t$1.Node,t$1.Right]),void(t$1=t$1.Left));
    }
  return[t$1,spine];
 };
